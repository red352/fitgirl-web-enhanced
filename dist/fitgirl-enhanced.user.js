...
(function() {
	...
	function prepareMedia(article, transaction, mediaExpanded = true) {
		...
		[...article.media.filter((item) => item.image), ...article.media.filter((item) => item.video)].forEach((item, index) => {
	...
	function transformGame(article, transaction, mediaExpanded = true) {
